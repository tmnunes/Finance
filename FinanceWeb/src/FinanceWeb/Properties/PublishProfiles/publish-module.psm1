...
function Publish-AspNetMSDeploy{
    ...
    process{
        if($publishProperties){
            ...
            # <dbFullSql path="Data Source=tcp:webapplicationdbserver.database.windows.net,1433;Initial Catalog=WebApplication_db;User Id=sqlrtyrty@webapplicationdbserver;Password=<password>" />
            # <dbFullSql path="Data Source=tcp:webapplicationdbserver.database.windows.net,1433;Initial Catalog=WebApplication_db;User Id=sqlrtyrty@webapplicationdbserver;Password=<password>" />
            # </sitemanifest>
